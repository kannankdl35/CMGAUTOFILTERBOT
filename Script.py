...
ʏᴏᴜ ᴀʀᴇ ᴜꜱɪɴɢ ᴏɴᴇ ᴏꜰ ᴍʏ ᴏʟᴅ ᴍᴇꜱꜱᴀɢᴇꜱ, ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    I_CUDNT = """<b><i>❌ Sorry, the file was not found in the database.</i></b>

<blockquote expandable><i>Please check the following: ⬇️

• Make sure the <b>spelling</b> of the movie/series title is <b>correct</b>.

• The movie/series must be <b>released on OTT</b>. Theater prints are not available on this bot.

Example formats:</i>
<code>Vaazha 2
Vaazha 2 (2026)
Breaking Bad S01
Breaking Bad S01E02</code>
<i>
If both of the above points are correct and you still can't find the movie/series, <b>you can request</b> it by sending:</i>

<code>/request Movie or Series Name</code>

<i>Example:</i>
<code>/request Narasimham
/request Baahubali</code>

<i>📌 <b>Admin will check the requested movie/series and inform you once it is available.</b></i></blockquote>

<b><i>❌ ക്ഷമിക്കണം, ഈ ഫയൽ ഡാറ്റാബേസിൽ കണ്ടെത്താൻ കഴിഞ്ഞില്ല.</i></b>

<blockquote expandable><i>താഴെ പറയുന്ന കാര്യങ്ങൾ ഒന്ന് ചെക്ക് ചെയ്യൂ. ⬇️

• നിങ്ങൾ നൽകിയ movie/series ന്റെ <b>spelling</b> ശരിയാണെന്ന് ഉറപ്പാക്കുക.

• ആ movie/series <b>OTT-യിൽ റിലീസ് ആയിരിക്കണം.</b> Theater print ഈ bot-ൽ ലഭ്യമല്ല.
...
<i>മുകളിലെ രണ്ട് കാര്യങ്ങളും ശരിയാണെങ്കിലും movie/series ഇപ്പോഴും കിട്ടുന്നില്ലെങ്കിൽ, അത് <b>request ചെയ്യാം:</b></i>
...
<i>📌 നിങ്ങൾ request ചെയ്യുന്ന movie/series admin check ചെയ്യും. Available ആയിക്കഴിഞ്ഞാൽ നിങ്ങളെ അറിയിക്കും.</i></blockquote>"""
    ...
    MVE_NT_FND = """ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ. ᴍᴀᴋʀ ꜱᴜʀᴇ ᴛʜᴇ ᴍᴏᴠɪᴇ ᴀʟʀᴇᴀᴅʏ ʀᴇʟᴇᴀꜱᴇᴅ ᴏɴ ᴏᴛᴛ. (ʏᴏᴜ ᴅᴏɴ'ᴛ ɢᴇᴛ ᴀɴʏ ᴛʜᴇᴀᴛᴇʀ ᴩʀɪɴᴛ ꜰʀᴏᴍ ᴛʜɪꜱ ɢʀᴏᴜᴩ. ᴏɴʟʏ ᴏᴛᴛ ʀᴇʟᴇᴀꜱᴇᴅ ᴍᴏᴠɪᴇꜱ ᴀʀᴇ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴏᴜʀ ᴅʙ)"""
...
ɪꜰ ʏᴏᴜ ᴅᴏ ɴᴏᴛ ꜱᴇᴇ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ᴍᴏᴠɪᴇ / sᴇʀɪᴇs ꜰɪʟᴇ, ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇ"""
    ...
    SINFO = """<b>To Use This Group, You Must be a Member of Our Channel. Join The Channel Using The 'JOIN' Button Below, And Then Click The 'UNMUTE' Button.

ഗ്രൂപ്പിൽ നിന്നും സിനിമ ലഭിക്കുവാൻ താഴെയുള്ള 'JOIN' ബട്ടൺ ക്ലിക്ക് ചെയ്ത് ചാനലിൽ ജോയിൻ ആയ ശേഷം 'UNMUTE' ബട്ടൺ ക്ലിക്ക് ചെയുക. 😊</b>"""
