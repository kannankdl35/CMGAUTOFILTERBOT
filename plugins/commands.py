...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        ...
        buttons = [[
                ...
                InlineKeyboardButton('📽️ 𝘈𝘋𝘋 𝘔𝘌 𝘛𝘖 𝘠𝘖𝘜𝘙 𝘎𝘙𝘖𝘜𝘗 📽️', url=f'http://t.me/{temp.U_NAME}?startgroup=true&admin=invite_users')
            
            ],[

                InlineKeyboardButton('🍿 𝘑𝘖𝘐𝘕 𝘔𝘖𝘝𝘐𝘌 𝘎𝘙𝘖𝘜𝘗 🍿', url=GRP_LNK)

            ],[

                InlineKeyboardButton('🎞️ 𝘕𝘌𝘞 𝘙𝘌𝘓𝘌𝘈𝘚𝘌𝘚 🎞️', url=CHNL_LNK),

                InlineKeyboardButton('🔗 𝘊𝘏𝘈𝘕𝘕𝘌𝘓 𝘓𝘐𝘕𝘒𝘚 🔗', url=f'https://t.me/{SUPPORT_CHAT}')

            ],[

                InlineKeyboardButton('💬 𝘊𝘖𝘕𝘛𝘈𝘊𝘛 𝘈𝘋𝘔𝘐𝘕 💬', url=OWNER_LNK)
