...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        ...
        buttons = [[
                ...
                InlineKeyboardButton('🎬 𝘈𝘥𝘥 𝘔𝘦 𝘛𝘰 𝘠𝘰𝘶𝘳 𝘎𝘳𝘰𝘶𝘱 🎬', url=f'http://t.me/{temp.U_NAME}?startgroup=true&admin=invite_users')
            
            ],[

                InlineKeyboardButton('🍿 𝘑𝘰𝘪𝘯 𝘔𝘰𝘷𝘪𝘦 𝘎𝘳𝘰𝘶𝘱 🍿', url=GRP_LNK)

            ],[

                InlineKeyboardButton('🎞️ 𝘕𝘦𝘸 𝘙𝘦𝘭𝘦𝘢𝘴𝘦𝘴  🎞️', url=CHNL_LNK),

                InlineKeyboardButton('🔗 𝘊𝘩𝘢𝘯𝘯𝘦𝘭 𝘓𝘪𝘯𝘬𝘴 🔗', url=f'https://t.me/{SUPPORT_CHAT}')

            ],[

                InlineKeyboardButton('💬 𝘊𝘰𝘯𝘵𝘢𝘤𝘵 𝘈𝘥𝘮𝘪𝘯 💬', url=OWNER_LNK)
