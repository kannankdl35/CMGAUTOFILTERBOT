...
BOT_TOKEN = environ.get('BOT_TOKEN', "7744617382:AAEGHj8g9fBTEMIqFoN2coHS78523uDWjTw")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.picrd.com/images/tjiGnhDDMJZ.png')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1994878828').split()] # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002943359781')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://psychologixyt:XVrf4LxmCwnPO7xU@cluster0.5zy3b.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
MSG_ALRT = environ.get('MSG_ALRT', 'Loading...')
